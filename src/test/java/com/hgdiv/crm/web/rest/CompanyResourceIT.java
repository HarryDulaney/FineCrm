...
import com.hgdiv.crm.domain.Company;
import com.hgdiv.crm.repository.CompanyRepository;
...
class CompanyResourceIT {
    ...
    public static Company createEntity(EntityManager em) {
        Company company = new Company().companyName(DEFAULT_COMPANY_NAME).address(DEFAULT_ADDRESS).primaryContact(DEFAULT_PRIMARY_CONTACT);
        return company;
    }
    ...
    public static Company createUpdatedEntity(EntityManager em) {
        Company company = new Company().companyName(UPDATED_COMPANY_NAME).address(UPDATED_ADDRESS).primaryContact(UPDATED_PRIMARY_CONTACT);
        return company;
    }
    ...
    void getAllCompanies() throws Exception {
        ...
        restCompanyMockMvc
            ...
            .andExpect(jsonPath("$.[*].primaryContact").value(hasItem(DEFAULT_PRIMARY_CONTACT)));
    }
    ...
    void getCompany() throws Exception {
        ...
        restCompanyMockMvc
            ...
            .andExpect(jsonPath("$.primaryContact").value(DEFAULT_PRIMARY_CONTACT));
    }
    ...
    void putNewCompany() throws Exception {
        ...
        updatedCompany.companyName(UPDATED_COMPANY_NAME).address(UPDATED_ADDRESS).primaryContact(UPDATED_PRIMARY_CONTACT);
    ...
    void fullUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.companyName(UPDATED_COMPANY_NAME).address(UPDATED_ADDRESS).primaryContact(UPDATED_PRIMARY_CONTACT);
