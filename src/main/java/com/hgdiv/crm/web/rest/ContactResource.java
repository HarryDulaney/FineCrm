...
/**
 * REST controller for managing {@link com.hgdiv.crm.domain.Contact}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Contact> result = contactRepository
            ...
            .map(
                existingContact -> {
                    ...
                    if (contact.getLinkedInProfile() != null) {
                        existingContact.setLinkedInProfile(contact.getLinkedInProfile());
                    }
                    if (contact.getMailingAddress() != null) {
                        existingContact.setMailingAddress(contact.getMailingAddress());
                    }
                    if (contact.getConnectDate() != null) {
                        existingContact.setConnectDate(contact.getConnectDate());
                    }
                    if (contact.getJobTitle() != null) {
                        existingContact.setJobTitle(contact.getJobTitle());
                    }
                    if (contact.getLanguage() != null) {
                        existingContact.setLanguage(contact.getLanguage());
                    }
                    if (contact.getVip() != null) {
                        existingContact.setVip(contact.getVip());
                    }
                    if (contact.getAffiliate() != null) {
                        existingContact.setAffiliate(contact.getAffiliate());
                    }
